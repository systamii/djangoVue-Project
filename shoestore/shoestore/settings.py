...
with open(os.path.join(
        BASE_DIR, 'shoestore', 'secrets.json')) as f:
...
SECRET_KEY = 'django-insecure-&iz$d3uy@o)&48#fr4$d#pvply9+4^oti7a9)a972w%pi)%4e9'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "shoestore_static")
...
LOGIN_REDIRECT_URL = "/shoes/shoes/"
LOGOUT_REDIRECT_URL = "/"
